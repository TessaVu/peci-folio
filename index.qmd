...
## [Social Vulnerability Index (SVI)](https://www.atsdr.cdc.gov/place-health/php/svi/svi-frequently-asked-questions-faqs.html) Map
...
svi_map <- leaflet(map_tracts) %>%
  ...
  addLayersControl(
    overlayGroups = c("Population Density", "Median Household Income", "Socioeconomic Status SVI", "Household Characteristics SVI", "Racial & Ethnic Minority Status SVI", "Racial & Ethnic Minority Status SVI", "Housing Type & Transportation SVI", "Overall SVI"),
    options = layersControlOptions(collapsed = TRUE)
  ) %>%
