...
create_univariate_map <- function(data, var, var_name, color_option = "viridis") {
  ...
  ggplot(data) +
    ...
    scale_fill_viridis_d(name = var_name, option = color_option, direction = -1, alpha = 0.8, begin = 0.1, end = 0.9) +
    theme_universal_map()
}
```
...
# Create EJI maps
map_eji <- create_univariate_map(map_tracts, "RPL_EJI_CBM", "EJI Percentile", "rocket")

map_eji_pfas <- add_poi_layer(map_eji, PFAS_POI, "#DC143C", 0) +
  labs(title = "Environmental Justice Index (EJI)", 
...
# Create SVI maps
map_svi <- create_univariate_map(map_tracts, "RPL_themes", "SVI Percentile", "rocket")

map_svi_pfas <- add_poi_layer(map_svi, PFAS_POI, "#DC143C", 0) +
  labs(title = "Social Vulnerability Index (SVI)",
       subtitle = "PFAS Sampling Locations")
...
#ggsave("map_eji.png", map_eji, width = 14, height = 14, dpi = 300, bg = "#dedbd4")
```

### Univariate EJI PFAS Map

```{r visualize-eji-pfas}
#| echo: false
#| message: false
#| warning: false
#| fig-dpi: 300
...
#ggsave("map_eji_pfas.png", map_eji_pfas, width = 14, height = 14, dpi = 300, bg = "#dedbd4")
```

### Univariate EJI Microplastic Map
...
#ggsave("map_eji_mp.png", map_eji_mp, width = 14, height = 14, dpi = 300, bg = "#dedbd4")
```
...
#ggsave("map_svi.png", map_svi, width = 14, height = 14, dpi = 300, bg = "#dedbd4")
```

### Univariate SVI PFAS Map

```{r visualize-svi-pfas}
#| echo: false
#| message: false
#| warning: false
#| fig-dpi: 300
...
#ggsave("map_svi_pfas.png", map_svi_pfas, width = 14, height = 14, dpi = 300, bg = "#dedbd4")
```

### Univariate SVI Microplastic Map
...
#ggsave("map_svi_mp.png", map_svi_mp, width = 14, height = 14, dpi = 300, bg = "#dedbd4")
```
...
### Bivariate Microplastic Map

```{r visualize-bivariate-mp}
#| echo: false
#| message: false
#| warning: false
#| fig-dpi: 300
...
# Panel 1: All PFAS Maps (univariate EJI, univariate SVI, and bivariate)
...
pfas_panel_titled <- plot_grid(
  ggdraw() + draw_label("PFAS Contamination Sites", 
...
# Panel 2: All Microplastic Maps (univariate EJI, univariate SVI, and bivariate)
mp_panel <- plot_grid(
...
mp_panel_titled <- plot_grid(
  ggdraw() + draw_label("Microplastic Sampling Sites",
                        fontfamily = default_font_family,
                        fontface = "bold", size = 14),
  mp_panel,
  ncol = 1,
...
```{r visualize-correlation-analysis}
#| echo: false
#| message: false
#| warning: false
#| fig-dpi: 300
...
# ------ SAVE OUTPUTS ------
# Individual maps
#ggsave("complete_pfas_panel.png", pfas_panel_titled, width = 18, height = 7, dpi = 300, bg = "#dedbd4")

#ggsave("complete_mp_panel.png", mp_panel_titled, width = 18, height = 7, dpi = 300, bg = "#dedbd4")

# Master grid
#ggsave("complete_master_grid.png", master_grid_with_legend, width = 18, height = 16, dpi = 300, bg = "#dedbd4")
...
#ggsave("complete_master_grid_hires.pdf", master_grid_with_legend, bg = "#dedbd4", width = 18, height = 16, device = "pdf")
```
